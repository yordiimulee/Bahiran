...
export default function HelpCenterScreen() {
  ...
  const handleEmailContact = () => {
    const email = 'Support@bahiran.app';
  ...
  const handleTelegramContact = () => {
    const telegramUsername = 'Bahiran_support';
  ...
  const handleInstagramContact = () => {
    const instagramUsername = 'Bahiran_app';
  ...
  const handleTikTokContact = () => {
    const tiktokUsername = 'Bahiran_app';
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <View style={styles.contactContent}>
              ...
              <Text style={styles.contactDescription}>@Bahiran_support</Text>
            </View>
            <ChevronRight size={20} color={colors.lightText} />
          </TouchableOpacity>
          ...
          >
            ...
            <View style={styles.contactContent}>
              ...
              <Text style={styles.contactDescription}>@Bahiran_app</Text>
            </View>
            <ChevronRight size={20} color={colors.lightText} />
          </TouchableOpacity>
